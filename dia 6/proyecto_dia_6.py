...
def inicio():
    ...
    print('*' * 50)
    print('\n')
    print(f" Las recertas se encuentran en {mi_ruta}")
...
def crear_receta(ruta):
    ...
    while not existe:
        print("Esccribe el nombre de tu receta: ")
        ...
        if not os.path.exists(ruta_nueva):
            ...
            print("lo siento, esta receta a existe")
...
def eliminar_receta(receta):
    Path(receta).unlink()
    print(f"La {receta.name} haa sdo eliminada")
